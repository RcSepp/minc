...
extern "C"
{
	...
	void defineDefaultStmt2(BlockExprAST* scope, StmtBlock codeBlock, void* stmtArgs = nullptr);
	...
	void defineDefaultExpr2(BlockExprAST* scope, ExprBlock codeBlock, MincObject* type, void* exprArgs = nullptr);
	void defineDefaultExpr3(BlockExprAST* scope, ExprBlock codeBlock, ExprTypeBlock typeBlock, void* exprArgs = nullptr);
