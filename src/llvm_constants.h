...
{
	// LLVM-c types
	extern StructType* LLVMOpaquePassRegistry;
	extern StructType* LLVMOpaqueContext;
	extern StructType* LLVMOpaqueDiagnosticInfo;
	extern StructType* LLVMOpaqueAttributeRef;
	extern StructType* LLVMOpaqueModule;
	extern StructType* LLVMOpaqueModuleFlagEntry;
	extern StructType* LLVMOpaqueMetadata;
	extern StructType* LLVMOpaqueValue;
	extern StructType* LLVMOpaqueType;
	extern StructType* LLVMOpaqueValueMetadataEntry;
	extern StructType* LLVMOpaqueUse;
	extern StructType* LLVMOpaqueNamedMDNode;
	extern StructType* LLVMOpaqueBasicBlock;
	extern StructType* LLVMOpaqueBuilder;
	extern StructType* LLVMOpaqueModuleProvider;
	extern StructType* LLVMOpaqueMemoryBuffer;
	extern StructType* LLVMOpaquePassManager;
