...
struct SemanticTokensLegend{
	...
	MAKE_SWAP_METHOD(SemanticTokensLegend, tokenTypes, tokenModifiers)
};
MAKE_REFLECT_STRUCT(SemanticTokensLegend, tokenTypes, tokenModifiers)

struct SemanticTokensOptions :public TextDocumentRegistrationOptions
{
	/**
	 ...
	 */
	optional<bool> full;
	MAKE_SWAP_METHOD(SemanticTokensOptions, legend, range, full);
};
MAKE_REFLECT_STRUCT(SemanticTokensOptions, legend, range, full);
